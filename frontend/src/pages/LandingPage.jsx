    ...
    <div className="min-h-screen bg-brand-grey">
      ...
      <nav className="absolute top-0 left-0 w-full p-6 flex justify-between items-center z-50">
        ...
        <button 
          ...
          className="text-sm font-medium text-white bg-brand-card-bg/50 backdrop-blur-md px-5 py-2.5 rounded-full border border-brand-border/50 hover:bg-brand-card-bg hover:shadow-sm transition-all"
        >
          Member Login
        </button>
      </nav>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-card-bg/60 backdrop-blur-md border border-brand-border/50 text-xs font-medium uppercase tracking-widest text-white/70 mb-12 shadow-sm">
            <MapPin size={12} className="text-brand-orange" />
            Padanilam, Kerala
          </div>
          
          <h1 className="text-6xl md:text-[5.5rem] font-heading font-semibold text-white leading-[1.05] tracking-tight mb-8">
            Community, <br />
          ...
          <button 
            onClick={() => navigate('/login')}
            className="bg-brand-charcoal text-white text-lg px-10 py-4 rounded-full font-medium hover:scale-[1.02] hover:shadow-[0_8px_30px_rgb(0,0,0,0.3)] transition-all duration-300"
          >
            Access Portal
          </button>
        </div>
      ...
      <section className="py-32 px-6 max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-5xl font-medium text-white leading-tight tracking-tight mb-8">
          More than just a club. <br className="hidden md:block" />
          <span className="text-white/40">A movement for the community.</span>
        </h2>
        <p className="text-lg md:text-xl text-white/60 leading-relaxed font-light max-w-3xl mx-auto">
      ...
      {/* Activities Section */}
      <section className="py-24 px-6 bg-brand-card-bg border-y border-brand-border/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-semibold tracking-tight text-white">Our Focus</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="flex flex-col items-center text-center group">
                <div className="w-16 h-16 bg-brand-card-bg/30 rounded-2xl flex items-center justify-center mb-6 shadow-sm border border-brand-border/20 group-hover:scale-110 transition-transform duration-500">
                  <item.icon className={item.color} size={28} strokeWidth={1.5} />
                </div>
                <h3 className="text-xl font-medium mb-3 tracking-tight text-white">{item.title}</h3>
      ...
      <section className="py-32 px-6 text-center max-w-3xl mx-auto">
        <div className="w-20 h-20 bg-brand-card-bg/50 rounded-[1.5rem] flex items-center justify-center mx-auto mb-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-brand-border/20">
          <Instagram className="text-white/60" size={32} strokeWidth={1.5} />
        </div>
        <h2 className="text-4xl md:text-5xl font-semibold tracking-tight mb-6 text-white">Stay Connected.</h2>
        <p className="text-xl text-white/60 mb-12 font-light">Follow our journey and witness the community in action.</p>
        <a 
      ...
      {/* Footer Minimal */}
      <footer className="bg-brand-card-bg border-t border-brand-border/30 py-12 px-6">
